public class Main {
    public static void main(String[] args) {
        ...
        Student s1 = new Student("Krish", 101, "Engineering");
        Student s2 = new Student("Sandesh", 102, "Management");
        s1.displayProfile();
        s2.displayProfile();
        ...
        emailSys.sendNotification("ruben@university.edu", "Welcome to the semester!");
        smsSys.sendNotification("9768400750", "Your fee is due.");
    }
}